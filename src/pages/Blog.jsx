...
const Blog = () => {
  ...
  const [posts] = useState([
    ...
    {
      id: 2,
      title: "About Me - My Software Engineering Journey",
      date: "January 15, 2026",
      type: "video",
      videoUrl: "https://www.youtube.com/embed/your-video-id",
      description: "Watch my introduction and learn about my journey as a software engineer at Grambling State University...",
    },
    {
      id: 3,
    ...
    {
      id: 4,
      title: "Container Runtime Demo",
      date: "December 28, 2025",
      type: "video",
      videoUrl: "https://www.youtube.com/embed/your-video-id",
      description: "Watch a live demo of my Go container runtime showcasing process isolation with Linux namespaces and cgroups...",
    },
    {
      id: 5,
      title: "KubeFlowX - Kubernetes Orchestration Tool",
      date: "January 5, 2026",
      type: "post",
      content: "Building a web application for managing Kubernetes deployments and microservices with Spring Boot and Java K8s client. Features deployment management, scaling, and real-time monitoring...",
      image: null,
    },
    {
      id: 6,
      title: "KubeFlowX Architecture Walkthrough",
      date: "January 5, 2026",
      type: "video",
      videoUrl: "https://www.youtube.com/embed/your-video-id",
      description: "Technical walkthrough of my Kubernetes orchestration tool with real-time deployment management, scaling capabilities, and responsive web interface...",
    },
    {
      id: 7,
      ...
      type: "post",
      content: "Building a high-performance SQLite clone with B-tree indexing and persistent storage from scratch...",
      image: null,
    },
    {
      id: 8,
      title: "NanoSQL Technical Demo",
      date: "December 20, 2025",
      type: "video",
      videoUrl: "https://www.youtube.com/embed/your-video-id",
    ...
    },
    {
      ...
      type: "post",
      content: "How we built a housing platform for interns using Next.js, Firebase, and Puppeteer to win the ColorStack hackathon...",
      image: null,
    },
    {
      id: 10,
      title: "MateMatch Project Pitch",
      date: "January 10, 2026",
      type: "video",
      videoUrl: "https://www.youtube.com/embed/p18uDLfRCgI",
      description: "Watch David our project lead explain how we built a housing platform for interns using Next.js, Firebase, and Puppeteer...",
    },
  ]);
      ...
      <div className='mt-12 flex flex-col gap-12'>
        <div className='p-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border-2 border-blue-200 animate-in fade-in'>
          ...
          <p className='text-gray-700 mb-6 leading-relaxed'>
            Emmanuel is an aspiring software engineer with hands-on experience in full-stack development, 
            microservices architecture, and machine learning research. He has built production systems 
